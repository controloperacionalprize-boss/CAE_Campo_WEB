...
FIELD_LABELS: dict[str, str] = {
    ...
    "recepcionado_at": "fecha de recepción",
    "recepcionado_acopio": "recepcionado en acopio",
    "recepcionado_acopio_at": "fecha de recepción en acopio",
    "recepcionado_planta": "recepcionado en planta",
    "recepcionado_planta_at": "fecha de recepción en planta",
    "modulo": "módulo",
    "turno": "turno",
    "lote": "lote",
